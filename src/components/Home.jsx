...
const Home = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4 md:p-6 bg-[#191922]"> 
        <div className="shadow-md shadow-[#ffff] rounded-lg p-6 w-full max-w-lg bg-[#14141f]"> 
